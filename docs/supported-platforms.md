# Semanticus 1.1.3 support and limitations

This is the public support contract for Semanticus 1.1.3. A package is accepted only when its bundled engine is
